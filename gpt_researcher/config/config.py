...
class Config:
    ...
    def __init__(self, config_file: str = None):
        ...
        self.fast_llm_model = os.getenv('FAST_LLM_MODEL', "mixtral:8x7b-instruct-v0.1-q6_K")
        self.smart_llm_model = os.getenv('SMART_LLM_MODEL', "mixtral:8x7b-instruct-v0.1-q6_K")
